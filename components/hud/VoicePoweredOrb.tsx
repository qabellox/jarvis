...
/**
 * VoicePoweredOrb — the vibrational sound orb (WebGL shader).
 *
 * The exact component blueprint requested: a procedural GLSL sphere (simplex
 * noise, hue-shifted cyan/blue core) that rotates and distorts in real time
 * with the microphone signal. `enableVoiceControl` should follow the HUD's
 * `listening` flag so it listens to real voice only while the mic is live.
 */
export const VoicePoweredOrb: FC<VoicePoweredOrbProps> = ({
  ...
  `;
    ...
    useEffect(() => {
        ...
        const handleMicrophoneState = async (): Promise<void> => {
            if (enableVoiceControl) {
